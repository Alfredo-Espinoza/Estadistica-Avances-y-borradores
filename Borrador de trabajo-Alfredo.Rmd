Este es un planteamiento inicial del trabajo, que se realizó en dos archivos separados con Claudia Linares. Es decir, ambos avanzaron por su cuenta más o menos el mismo código. A partir de la línea 522 se desarrolla el trabajo con las variables, que fueron limpiadas y combinadas por otros miembros. Finalmente, se descartó esta idea por tener muy pocas variables.
#Alfredo Espinoza
